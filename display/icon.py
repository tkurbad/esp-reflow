...
def string_to_icon(ascii_image):
    ...
    # ]
    # The following code unfolds the nested lists to:
    #  [upmost_byte_of_first_row, ..., upmost_byte_of_last_row,
    #   ...,
    #  [lowermost_byte_of_first_row, ..., lowermost_byte_of_last_row]
...
class FanIcon(Icon):
    ...
    def __init__(self):
        bitmask = b'pxx0\xb0\xe2\x7f\xdf\xce\xe0\xe0\xe0\x00\x00\x00\x07\x0f\x0f\x04\x00\x00\x01\x01\x00'
        height = 12
        width = 12
...
class AnimatedFanIcon(AnimatedIcon):
    ...
    def __init__(self):
        bitmask_list = [
            b'pxx0\xb0\xe2\x7f\xdf\xce\xe0\xe0\xe0\x00\x00\x00\x07\x0f\x0f\x04\x00\x00\x01\x01\x00',
            b'\x00\x8c\x9e\xceN|\xe0 >\x9e\x1c\x00\x00\x03\x07\x07\x00\x00\x03\x07\x07\x07\x03\x00'
            ]
        height = 12
        width = 12
